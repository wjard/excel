...
namespace excel;
public class BrazilianPortugueseNumberToWordsConverter : GenderedNumberToWordsConverter
{
 ...
 public override string Convert(long input, GrammaticalGender gender, bool addAnd = true)
 {
  ...
  {
   parts.Add(number / 1000000000000000000 >= 2
       ? string.Format("{0} quintrilhões", Convert(number / 1000000000000000000, GrammaticalGender.Masculine))
       : string.Format("{0} quintrilhão", Convert(number / 1000000000000000000, GrammaticalGender.Masculine)));
   number %= 1000000000000000000;
  }

  if ((number / 1000000000000000) > 0)
  {
   parts.Add(number / 1000000000000000 >= 2
       ? string.Format("{0} quatrilhões", Convert(number / 1000000000000000, GrammaticalGender.Masculine))
       : string.Format("{0} quatrilhão", Convert(number / 1000000000000000, GrammaticalGender.Masculine)));
   number %= 1000000000000000;
  }

  if ((number / 1000000000000) > 0)
  {
   // gender is not applied for trillions
   parts.Add(number / 1000000000000 >= 2
       ? string.Format("{0} trilhões", Convert(number / 1000000000000, GrammaticalGender.Masculine))
       : string.Format("{0} trilhão", Convert(number / 1000000000000, GrammaticalGender.Masculine)));
